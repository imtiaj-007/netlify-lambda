    ...
    try {
        ...
        <body>
            ...
            <section class="container my-3">
                <h3 class="heading">Electricity Bill</h3>
                <div class="row p-3">
                    <div class="col-8">
        ...
        const html = htmlTemplate.replace(/{{customerId}}/g, user._id)
            .replace(/{{customerName}}/g, user.customerName)
            .replace(/{{email}}/g, user.email)
            .replace(/{{billNo}}/g, bill._id)
            .replace(/{{units}}/g, bill.units)
            .replace(/{{amount}}/g, bill.amount)
            .replace(/{{connecType}}/g, user.connectionType)
